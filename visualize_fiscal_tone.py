"""
Fiscal Tone Visualization

Generates two plots from LLM classification results:
1. Stacked area chart showing score distribution over time
2. Fiscal tone index time series with moving average

Author: Based on original code by user
Date: 2025-01-28
"""
...
print("="*80)
print(" FISCAL TONE VISUALIZATION ".center(80, "="))
print("="*80)

# Load document-level aggregated data
print("\n[LOADING] Loading aggregated data...")
df_doc_summary = pd.read_csv("data/output/llm_output_documents.csv")
...
# Save
output_file_1 = "Fig_Distribucion.png"
