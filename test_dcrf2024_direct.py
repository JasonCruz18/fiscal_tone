"""
Direct test of extract_text_from_single_pdf_v2 on Informe-DCRF2024-vf.pdf
Copying the function directly to avoid import issues
"""
#%%
import sys
import os
...
print("\n" + "="*100)
print("DIRECT TEST: Informe-DCRF2024-vf.pdf with keyword detection")
print("="*100)
print("\nExpected behavior:")
print("  - Should find '4. Opinión del Consejo Fiscal' on page 5")
print("  - Should start extraction from page 5, skipping pages 1-4")
print("\n" + "="*100 + "\n")
...
with pdfplumber.open(test_file) as pdf:
    ...
    # Show what pages would be processed
    print(f"\n{'─'*100}")
